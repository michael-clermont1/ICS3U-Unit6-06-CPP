...
std::list<std::string> HexadecimalTranslator(std::string str) {
...
main() {
    ...
    std::list<std::string> translatedString;
    std::string untranslatedString = "";
    ...
    std::cin >> untranslatedString;
    bool includeComma = false;
    // call functions
    translatedString = HexadecimalTranslator(untranslatedString);

    for (std::string singleElement : translatedString) {
            arrayString.push_back(dictionary[singleElement]);
    }
    for (std::string singleUnicode : translatedString) {
        if (includeComma) {
            std::cout << ", ";
        }
